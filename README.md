...
| **`ANATOMY.md`** | A definição canônica do que é um repo panlabs: três eixos, cinco tipos, invariantes e slots, com o catálogo cheio dos 33 itens. Um teste amarra a tabela de lá ao catálogo executável, nos dois sentidos: item escrito sem veredito seria recomendação, e a leitura binária proíbe recomendação. |
